...
export function registerGracefulShutdown(steps, { timeoutMs = DEFAULT_TIMEOUT_MS } = {}) {
...
export const SHUTDOWN_TIMEOUT_MS = readPositiveIntegerEnv("SHUTDOWN_TIMEOUT_MS", DEFAULT_TIMEOUT_MS);
